"""Commit 07 refinement: intent-keyed deterministic policy citations."""

from src.llm.prompt_versions.v2 import SYSTEM_INSTRUCTIONS as V2_SYSTEM_INSTRUCTIONS


PROMPT_VERSION = "commit07_v5_intent_keyed_quote_rag"
PROMPT_CHANGE_HYPOTHESIS = (
    "Making every deterministic planner intent a required structured-output "
    "field, with quote choices restricted to that intent, should raise policy-"
    "document and policy-family citation from the V4 cohort's 80% to at least "
    "90% while preserving 100% answer correctness and citation grounding."
)
